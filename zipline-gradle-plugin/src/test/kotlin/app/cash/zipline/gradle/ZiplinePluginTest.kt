...
class ZiplinePluginTest {
  ...
  fun webpackBuild() {
    ...
    val ziplineWebpackConfig = projectDir.resolve("lib/${WriteWebpackConfigTask.generatedFilePath}")
    val ziplineWebpackConfigContents = ziplineWebpackConfig.readText()
    assertThat(ziplineWebpackConfigContents)
      .contains("// This file is generated by the Zipline Gradle plugin.")
  }
