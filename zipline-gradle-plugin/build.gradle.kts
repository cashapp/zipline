...
dependencies {
  ...
  implementation(libs.jetty.ee10Servlet)
  implementation(libs.jetty.ee10WebsocketJettyServer)
...
tasks {
  test {
    ...
    dependsOn(":zipline-android-ndk:publishAllPublicationsToTestMavenRepository")
    ...
    dependsOn(":zipline:publishAndroidPublicationToTestMavenRepository")
