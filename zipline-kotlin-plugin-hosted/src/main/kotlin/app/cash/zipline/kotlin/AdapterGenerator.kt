 ...
 * `ZiplineService`. See `EchoZiplineService.Companion.ManualAdapter` for a sample implementation
...
internal class AdapterGenerator(
  ...
  // private val service: EchoZiplineService = service
  ...
  private fun irOutboundServiceFunction(
    ...
    // override fun outboundService(context: OutboundBridge.Context): EchoZiplineService
