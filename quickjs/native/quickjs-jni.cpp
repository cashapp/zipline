...
extern "C" JNIEXPORT jobject JNICALL
Java_app_cash_quickjs_QuickJs_memoryUsage(JNIEnv* env, jobject type, jlong context_) {
  Context* context = reinterpret_cast<Context*>(context_);
  if (!context) {
    throwJavaException(env, "java/lang/NullPointerException",
                       "Null QuickJs context - did you close your QuickJs?");
...
extern "C" JNIEXPORT void JNICALL
Java_app_cash_quickjs_QuickJs_setMemoryLimit(JNIEnv* env, jobject type, jlong context_, jlong limit) {
  Context* context = reinterpret_cast<Context*>(context_);
  if (!context) {
    throwJavaException(env, "java/lang/NullPointerException",
                       "Null QuickJs context - did you close your QuickJs?");
...
extern "C" JNIEXPORT void JNICALL
Java_app_cash_quickjs_QuickJs_setGcThreshold(JNIEnv* env, jobject type, jlong context_, jlong gcThreshold) {
  Context* context = reinterpret_cast<Context*>(context_);
  if (!context) {
    throwJavaException(env, "java/lang/NullPointerException",
                       "Null QuickJs context - did you close your QuickJs?");
...
extern "C" JNIEXPORT void JNICALL
Java_app_cash_quickjs_QuickJs_setMaxStackSize(JNIEnv* env, jobject type, jlong context_, jlong stackSize) {
  Context* context = reinterpret_cast<Context*>(context_);
  if (!context) {
    throwJavaException(env, "java/lang/NullPointerException",
                       "Null QuickJs context - did you close your QuickJs?");
