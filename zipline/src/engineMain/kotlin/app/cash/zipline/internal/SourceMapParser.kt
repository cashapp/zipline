...
/**
 * Parses the contents of a source map file to enable mapping from the elements in the transformed
 * (e.g. minified) source to the elements in the original source. This is an implementation of the
